...
namespace HappyShoot.View.SkillTree
{
    ...
    public static class SkillTreeSpriteHelper
    {
        ...
        public static Sprite GetGemSprite(GemType type) => GemSpriteHelper.GetGemSprite(type);
        public static Sprite GetOrCreateRubySprite(int size = 32) => GemSpriteHelper.GetOrCreateRubySprite(size);
        public static Sprite GetOrCreateEmeraldSprite(int size = 32) => GemSpriteHelper.GetOrCreateEmeraldSprite(size);
        public static Sprite GetOrCreateAmethystSprite(int size = 32) => GemSpriteHelper.GetOrCreateAmethystSprite(size);
