    ...
    public class CharacterSelectUiView : MonoBehaviour
    {
        ...
        private void EnsureUiElements()
        {
            ...
            CreateCharacterCard(
                ...
                name: "WarriorCard",
                title: "🛡️ 전사 (Warrior)",
                heroSprite: HeroSpriteHelper.GetHeroSprite(CharacterClassType.Warrior, HeroSpriteHelper.ViewDirection.Front, 36),
            ...
            CreateCharacterCard(
                ...
                name: "RangerCard",
                title: "🏹 궁수 (Ranger)",
                heroSprite: HeroSpriteHelper.GetHeroSprite(CharacterClassType.Ranger, HeroSpriteHelper.ViewDirection.Front, 36),
            ...
            CreateCharacterCard(
                ...
                name: "WizardCard",
                title: "🧙 마법사 (Wizard)",
                heroSprite: HeroSpriteHelper.GetHeroSprite(CharacterClassType.Wizard, HeroSpriteHelper.ViewDirection.Front, 36),
                statsDesc: "⚡ 쿨타임 감소: -15%\n🔮 스킬 범위: +20% (광역 특화)\n✨ 공격력: +25%",
