...
namespace HappyShoot.Domain.Skills.Effects
{
    ...
    public class StellarRainEffect : ISkillEffect
    {
        ...
        public StellarRainEffect(float baseDamage = 75f, float radius = 5.0f, int arrowCount = 60)
        {
        ...
        public void ApplyEffect(SkillContext context, IList<Vector2D> targetPositions)
        {
            ...
            context.EventBus?.Publish(new StellarRainExecutedEvent(targetCenter, effectiveRadius, effectiveDamage, ArrowCount));
